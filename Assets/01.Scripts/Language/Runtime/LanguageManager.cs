...
public class LanguageManager : MonoSingleton<LanguageManager>
{
    ...
    public Observer_Pattern<SystemLanguage> OnSetLanguage { get; private set; } = new Observer_Pattern<SystemLanguage>();
    public Observer_Pattern<Font> OnSetFont { get; private set; } = new Observer_Pattern<Font>();
    ...
    public string GetText_Random(string strLanguageKey_StartWidth)
    {
        ...
        if (arrMatchKey == null || arrMatchKey.Any() == false)
        {
